...
Route::get('person1','PersonController@person1');

Route::get('person/find','PersonController@find');
Route::post('person/find','PersonController@search');

Route::get('person/personname','PersonController@personname');
Route::post('person/personname','PersonController@personsearch');

Route::get('person/thename','PersonController@thename');
Route::post('person/thename','PersonController@thesearch');

Route::get('person/add','PersonController@add');
Route::post('person/add','PersonController@create');

Route::get('child','ChildrenController@index');
Route::get('child1','ChildrenController@getdata');

Route::get('childadd','ChildrenController@childadd');
Route::post('childadd','ChildrenController@childcreate');

Route::get('person/edit','PersonController@edit');
Route::get('person/henkou','PersonController@henkou');
Route::post('person/henkou','PersonController@henkoupost');

Route::get('person/del','PersonController@del');
Route::get('person/del1','PersonController@del1');
Route::post('person/del1','PersonController@remove');
